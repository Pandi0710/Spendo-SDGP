...
with_node \
  ...
  --target "/Users/pramusj/Downloads/Spendo-SDGP-main/Spendo/ios/Pods/Target Support Files/Pods-Spendo/ExpoModulesProvider.swift" \
  --entitlement "/Users/pramusj/Downloads/Spendo-SDGP-main/Spendo/ios/Spendo/Spendo.entitlements" \
  --platform "apple" \
  --packages "@react-native-google-signin/google-signin" "expo" "expo-application" "expo-asset" "expo-blur" "expo-constants" "expo-crypto" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linking" "expo-router" "expo-secure-store" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
